...
function Become() {
  return (
    <div className="bg-[#FEFEFE] sm:pt-20 pt-[108px] sm:px-0 px-[122px]">
      <h1
        className="text-[#333333] font-light leading-[60px] sm:text-[33px] sm:leading-[40px] text-[45px] sm:mt-[30px]
       mb-[20px] sm:ml-0 ml-[94px] max-w-[904px]"
      >
        You don’t just become something, you become someone
      </h1>
      <div className="grid grid-flow-col px-[10px] shadow-card-shadow sm:grid-flow-row sm:-bottom-0 -bottom-10 z-10 relative">
        <div className="py-[30px] justify-between sm:px-[20px]  flex px-[40px] bg-[#0077B3]">
          <input
            placeholder="Search..."
            type="search"
